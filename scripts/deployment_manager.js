...
// Obtiene los scripts de despliegue de los contratos ERC20, ERC721 y MarketPlace.
...
const main = async () => {
    ...
    // Despliega el contrato MarketPlace utilizando las direcciones de los contratos de MyCoin y MyNFTCollection.
